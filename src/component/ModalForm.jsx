    ...
    return (
      ...
      <form onSubmit={handleSubmit(a)} className="space-y-4 text-slate-700">
        ...
        <div className="form-control w-full">
          <label className="label font-semibold text-sm pb-1 dark:text-white text-slate-800">User Email</label>
          <input 
            type="email" 
            value={user?.email}
            disabled 
            className="input input-bordered w-full bg-slate-50 dark:bg-slate-800 dark:text-gray-400 text-slate-500 cursor-not-allowed border-slate-200"
          />
        </div>

        <div className="form-control w-full">
          <label className="label font-semibold text-sm pb-1 dark:text-white text-slate-800">Doctor Name</label>
          <input 
            type="text" 
            value={p.name} 
            disabled 
        ...
        <div className="w-full">
          <label className="label font-semibold dark:text-white text-sm pb-1 text-slate-800">Patient Name *</label>
          <input 
            type="text" 
            name="patientName"
      ...
      <Select.Popover>
        <ListBox selectionMode="multiple">
          ...
          <div className="form-control w-full">
            <label className="label font-semibold text-sm pb-1 text-slate-800 dark:text-white">Phone *</label>
            <input 
              type="text" 
              name="phone"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="form-control w-full">
            <label className="label font-semibold dark:text-white text-sm pb-1 text-slate-800">Date *</label>
            <input 
              type="date" 
              name="date"
