...
const Section1 = () => {
    return (
      ...
      <section className="py-20 mt-30 bg-slate-50">
  <div className="max-w-7xl mx-auto px-6">
    ...
    <div className="grid md:grid-cols-4 gap-8">
      <div className="bg-white p-8 rounded-3xl shadow-sm shadow-cyan-500 hover:shadow-xl transition duration-300 text-center">
